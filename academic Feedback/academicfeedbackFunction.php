...
function fetchDataForMasterSheet($fromDate,$todate){
    include("../database_connection.php");
...
// function fetchDataForFacultyBatchCoordBatch($fromdate,$todate,$selectedvalue1,$selectedvalue2,$selectedvalue3){

//     include("../database_connection.php");
//     $query = "SELECT checklist_record.checklist_id,checklist_record.class_date,checklist_record.batch,checklist_record.subject,checklist_record.faculty,checklist_record.batch_coordinator,academic_feedback_record.class_start_time,academic_feedback_record.overall_rating_for_the_class,academic_feedback_record.major_topics_covered,academic_feedback_record.faculty_primarily_used_language,academic_feedback_record.percentage_secondary_language,academic_feedback_record.preparation_for_class,academic_feedback_record.organization_of_content,academic_feedback_record.dictation_in_class,academic_feedback_record.no_pages_dictated_in_class,academic_feedback_record.factual_errors_or_conceptual_lags,academic_feedback_record.factual_errors_or_conceptual_lags_text,academic_feedback_record.faculty_meet_your_expectations,academic_feedback_record.video_portion_removed,academic_feedback_record.No_of_live_query,academic_feedback_record.management_technical_issue,academic_feedback_record.specific_issue_highlighted_by_students,academic_feedback_record.any_other_feedback
//     FROM checklist_record LEFT JOIN academic_feedback_record ON checklist_record.checklist_id = academic_feedback_record.checklist_id 
//     WHERE (checklist_record.checklist_type = 'Class' OR checklist_record.checklist_type = 'Offline')
//      AND ";


//     if(isset($selectedvalue1) && $selectedvalue1 != ''){
//         $query = $query . "checklist_record.faculty = '$selectedvalue1' AND ";
//     }
//     if(isset($selectedvalue2) && $selectedvalue2 != ''){
//         $query = $query . "checklist_record.batch_coordinator = '$selectedvalue2' AND ";
//     }
//     if(isset($selectedvalue3) && $selectedvalue3 != ''){
//         $query = $query . "checklist_record.batch = '$selectedvalue3' AND ";
//     }


//     $query = $query . " checklist_record.class_date between '$fromdate' and '$todate'";
// //     echo $selectedvalue1;
// //     echo $selectedvalue2;
// //     echo $selectedvalue3;
// //    print_r($query);
...
//         $dataForSummary[] = array("checklist_id" => $data['checklist_id'],"class_date" => $data['class_date'], "batch" => $data['batch'],"subject" => $data['subject'],
//         "faculty" => $data['faculty'],"batch_coordinator" => $data['batch_coordinator'],"class_start_time" => $data['class_start_time'],
//         "overall_rating_for_the_class" => $data['overall_rating_for_the_class'],"major_topics_covered" => $data['major_topics_covered'],
//         "faculty_primarily_used_language" => $data['faculty_primarily_used_language'],"percentage_secondary_language" => $data['percentage_secondary_language'],
//         "preparation_for_class" => $data['preparation_for_class'],"organization_of_content" => $data['organization_of_content'],"dictation_in_class" => $data['dictation_in_class'],"no_pages_dictated_in_class" => $data['no_pages_dictated_in_class'],
...
function fetchDataForFacultyBatchCoordBatch($fromdate,$todate,$selectedvalue1,$selectedvalue2,$selectedvalue3){
    ...
    include("../database_connection.php");
    // $query = "SELECT checklist_record.checklist_id,checklist_record.class_date,checklist_record.batch,checklist_record.subject,checklist_record.faculty,checklist_record.batch_coordinator,academic_feedback_record.class_start_time,academic_feedback_record.overall_rating_for_the_class,academic_feedback_record.major_topics_covered,academic_feedback_record.faculty_primarily_used_language,academic_feedback_record.percentage_secondary_language,academic_feedback_record.preparation_for_class,academic_feedback_record.organization_of_content,academic_feedback_record.dictation_in_class,academic_feedback_record.no_pages_dictated_in_class,academic_feedback_record.factual_errors_or_conceptual_lags,academic_feedback_record.factual_errors_or_conceptual_lags_text,academic_feedback_record.faculty_meet_your_expectations,academic_feedback_record.video_portion_removed,academic_feedback_record.No_of_live_query,academic_feedback_record.management_technical_issue,academic_feedback_record.specific_issue_highlighted_by_students,academic_feedback_record.any_other_feedback,
    // academic_feedback_record.preparation_for_class,academic_feedback_record.objective_of_class,academic_feedback_record.command_over_content,academic_feedback_record.use_of_examples,academic_feedback_record.organization_of_content,academic_feedback_record.time_management,academic_feedback_record.use_of_smart_board,academic_feedback_record.energy_level_and_communication
    // FROM checklist_record LEFT JOIN academic_feedback_record ON checklist_record.checklist_id = academic_feedback_record.checklist_id 
    // WHERE (checklist_record.checklist_type = 'Class' OR checklist_record.checklist_type = 'Offline')
    //  AND ";

    $query = "SELECT `checklist_record`.*,`academic_feedback_record`.*,`academic_feedback_record_remark`.*
         FROM checklist_record LEFT JOIN academic_feedback_record ON checklist_record.checklist_id = academic_feedback_record.checklist_id LEFT JOIN academic_feedback_record_remark ON academic_feedback_record_remark.checklist_id = academic_feedback_record.checklist_id
         WHERE (checklist_record.checklist_type = 'Class' OR checklist_record.checklist_type = 'Offline')
         AND ";
...
//    print_r($query);
    ...
    while($data = mysqli_fetch_assoc($run)){
        ...
        // array("checklist_id" => $data['checklist_id'],"class_date" => $data['class_date'], "batch" => $data['batch'],"subject" => $data['subject'],
        // "faculty" => $data['faculty'],"batch_coordinator" => $data['batch_coordinator'],"class_start_time" => $data['class_start_time'],
        // "overall_rating_for_the_class" => $data['overall_rating_for_the_class'],"major_topics_covered" => $data['major_topics_covered'],
        // "faculty_primarily_used_language" => $data['faculty_primarily_used_language'],"percentage_secondary_language" => $data['percentage_secondary_language'],
        // "preparation_for_class" => $data['preparation_for_class'],"organization_of_content" => $data['organization_of_content'],"dictation_in_class" => $data['dictation_in_class'],"no_pages_dictated_in_class" => $data['no_pages_dictated_in_class'],
        ...
        // "faculty_meet_your_expectations" => $data['faculty_meet_your_expectations'],"video_portion_removed" => $data['video_portion_removed'],"No_of_live_query" => $data['No_of_live_query'],
        // "management_technical_issue" => $data['management_technical_issue'],"specific_issue_highlighted_by_students" => $data['specific_issue_highlighted_by_students'],
        // "any_other_feedback" => $data['any_other_feedback'],"objective_of_class" => $data['objective_of_class'],"command_over_content" => $data['command_over_content'],"use_of_examples" => $data['use_of_examples']
    // ); 
