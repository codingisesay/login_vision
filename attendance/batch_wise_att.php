...
$(document).ready(function(){
  $("#offline").on("click",function(){
    ...
    if(from != ""){
    $.ajax({
      url:"load_graph_batch_single.php",
      type:"POST",
      data:{batch:batch,from:from,to:to},
      success:function(data){
       $("#chartContainer").html(data);
       $.ajax({
        url:"load_table_subject_single.php",
        type:"POST",
        data:{batch:batch,from:from,to:to},
        success:function(data){
...
if(from != ""){
$.ajax({
  url:"offline_percentage_load_graph_batch_single.php",
  type:"POSt",
  data:{batch:batch,from:from,to:to},
  success:function(data){
   $("#chartContainer").html(data);
   $.ajax({
    url:"offline_percentage_load_table_batch_single.php",
    type:"POST",
    data:{batch:batch,from:from,to:to},
    success:function(data){
     $("#load_table_data").html(data)
...
if(from != ""){
$.ajax({
url:"online_load_graph_batch_single.php",
type:"POSt",
data:{batch:batch,from:from,to:to},
success:function(data){
$("#chartContainer").html(data);
$.ajax({
 url:"online_load_table_batch_single.php",
 type:"POST",
 data:{batch:batch,from:from,to:to},
 success:function(data){
  $("#load_table_data").html(data)
...
if(from != ""){
$.ajax({
url:"online_percentage_load_graph_batch_single.php",
type:"POSt",
data:{batch:batch,from:from,to:to},
success:function(data){
$("#chartContainer").html(data);
$.ajax({
 url:"online_perentage_load_table_batch_single.php",
 type:"POST",
 data:{batch:batch,from:from,to:to},
 success:function(data){
  $("#load_table_data").html(data)
