...
<button type="button" class="btn btn-lg btn-info collapsed" data-toggle="collapse" data-target="#demo">Class Information</button>
<button type="button" class="btn btn-lg btn-info collapsed" data-toggle="collapse" data-target="#demo1" <?php echo $section1 = ($lenguageused == 'Yes')?('disabled'):(''); ?>>Section 01</button>
<button type="button" class="btn btn-lg btn-info collapsed" data-toggle="collapse" data-target="#demo2" <?php echo $section2 = ($assignment_question_today_class != '')?('disabled'):(''); ?>>Section 02</button>
<button type="button" class="btn btn-lg btn-info collapsed" data-toggle="collapse" data-target="#demo3" <?php echo   $section3 = ($link_with_current_affairs != '')?('disabled'):('');?>>Section 03</button>
<button type="button" class="btn btn-lg btn-info collapsed" data-toggle="collapse" data-target="#demo4" <?php echo  $section4 = ($feedback_form_classroom_team != '')?('disabled'):(''); ?>>Section 04</button>
...
<tr style="display: none;">
    ...
    <td>Link with Current Affairs</td>
      ...
      <label class="form-check-label" for="radio1">
        <input type="radio" class="form-check-input radiosize" id="radio1" name="LinkwithCurrentAffairsrating" value="1" checked> 1
      </label>
    </div>
    <div class="form-check formcssradio displaynone">
      <label class="form-check-label" for="radio2">
        <input type="radio" class="form-check-input radiosize" id="radio2" name="LinkwithCurrentAffairsrating" value="2"> 2
      </label>
    </div>
    <div class="form-check formcssradio displaynone">
      <label class="form-check-label">
        <input type="radio" class="form-check-input radiosize" name="LinkwithCurrentAffairsrating" value="3"> 3
      </label>
    </div>
    <div class="form-check formcssradio displaynone">
      <label class="form-check-label">
        <input type="radio" class="form-check-input radiosize" name="LinkwithCurrentAffairsrating" value="4"> 4
      </label>
    </div>
    <div class="form-check formcssradio displaynone">
      <label class="form-check-label">
        <input type="radio" class="form-check-input radiosize" name="LinkwithCurrentAffairsrating" value="5"> 5
      </label>
    </div>
...
<div id="demo4" class="collapse">
  <form action="insert_academic_feedback_data.php" method="POST">
    ...
    <tr id="whatDifferencedone" style="display: none;">
        ...
        <td> <textarea class="form-control" rows="5" id="differencedonecomment" name="differencedonecomment" placeholder="Please Write Here" ></textarea></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
        <input type="checkbox" id="atAnyPoint" name="atAnyPoint" value="Yes"> Any other points including any management/technical issue<br>
         
        <textarea class="form-control" rows="5" id="atAnyPointcomment" name="atAnyPointcomment" placeholder="Please Enter The details" style="display:none;"></textarea><br>



        <input type="checkbox" id="issueHighlighted" name="issueHighlighted" value="Yes"> Any Specific issue highlighted or request made by student in today's
        class regarding anything related to Vision IAS services 
    
            <br> <textarea class="form-control" rows="5" id="issueHighlightedcomment" name="issueHighlightedcomment" placeholder="Please Write Here" style="display:none;"></textarea><br>



            <input type="checkbox" id="anyOtherFeedback" name="anyOtherFeedback" value="Yes"> Any other Feedback<br>
        
        <textarea class="form-control" rows="5" id="anyOtherFeedbackcomment" name="anyOtherFeedbackcomment" placeholder="Please Enter The details" style="display:none;"></textarea>
        </td>
    </tr>
    <tr>
