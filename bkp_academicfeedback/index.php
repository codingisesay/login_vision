  ...
  <div class="panel-group" id="accordion">
    ...
    <tbody>
      ...
      //  print_r($acadmicFeebackData);
        ...
        if($formStatus != ""){?>
                <td><a href="updateformAcademicFeedback.php?checklist_id=<?php echo $dateChecklistData[$allClass]['checklist id'];?>&class_id=<?php echo $dateChecklistData[$allClass]['class_id_from_lecture_list']; ?>" class="btn btn-success">Update</a>
