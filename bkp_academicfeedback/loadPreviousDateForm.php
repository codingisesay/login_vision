    ...
    <tbody>
      ...
      for($allClass = 0; $allClass < $allclasscount; $allClass++){
       ...
       $handoutStatus = $acadmicFeebackData[0]['handout_provided'];
        if($formStatus != ""){?>
                <td><a href="updateformAcademicFeedback.php?checklist_id=<?php echo $dateChecklistData[$allClass]['checklist id'];?>&class_id=<?php echo $dateChecklistData[$allClass]['class_id_from_lecture_list']; ?>" class="btn btn-success">Update Form</a>
