...
// LEFT JOIN user ON complaint_record.updated_by = user.user_id WHERE complaint_record.current_date between complaint_record.currentdate >= '$from_date 00:00:00' AND complaint_record.currentdate <='$to_date 23:59:59' ORDER BY complaint_record.complaint_record_id ASC";
